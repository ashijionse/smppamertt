...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://smppamertt.pages.dev/v/${file.filecode}`,
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://smppamertt.pages.dev/v/${file.filecode}`
            }  
        }
        }
...
<meta itemProp="uploadDate" content={`${new Date(
        ...
        {/* ... */}
            ...
            <iframe
                className="w-full h-[90vh] md:h-[90vh] lg:h-[90vh] overflow-n-auto"
